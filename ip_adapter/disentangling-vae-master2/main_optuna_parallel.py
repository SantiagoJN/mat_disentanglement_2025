...
def objective(trial, args, logger, stream, device, writer_dir, writer):
    ...
    exp_dir = os.path.join(RES_DIR, f'optuna/{args.name}_{epochs}_{latent_dim}_{gamma}_{learning_rate}_{learning_rate_disc}')
    ...
    # TODO: Primero probar a ejecutar el entrenamiento con la función objetivo pocha, y cuando vaya bien, adaptar lo otro
    # TODO: Primero probar a ejecutar el entrenamiento con la función objetivo pocha, y cuando vaya bien, adaptar lo otro
    # TODO: Primero probar a ejecutar el entrenamiento con la función objetivo pocha, y cuando vaya bien, adaptar lo otro
    # TODO: Primero probar a ejecutar el entrenamiento con la función objetivo pocha, y cuando vaya bien, adaptar lo otro
    # TODO: Primero probar a ejecutar el entrenamiento con la función objetivo pocha, y cuando vaya bien, adaptar lo otro
    ...
    # TODO: Implement to return the combination of the metrics (FactorScore + MIS)
...
def main(args):
    ...
    storage = JournalStorage(JournalFileStorage("HPO_parallel_attempt0"))
